from archive.common import CONTENT_STORE_SIZE, PACKET_LIFETIME, count_prefix_length
...
class Vertex(object):
    def __init__(self, _name, _text="", cache_size=CONTENT_STORE_SIZE):
        self.name = _name  # 传输路径名称： /edu.umich/ECE
        self.text = _text
        ...
        # 保存转发路由信息
        # maintains nexthop(s) and other information
        # for each reachable destination name prefix.
        self.FIB = {}  # next-hop key -> vertex 字典类型
