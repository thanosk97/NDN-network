...
advertise_string = '[food/co2/getGas, food/co2/getStatus, \
...
BARRACK_TYPE = 'food' # weapons,vehicle,accessory,radar,food
...
class Barrack():
    ...
    def callActuator1(self,interest,interest_method,interest_variable):
        ...
        # Unique sensor - food
        elif interest.lower() == 'food' and interest_method.lower() == 'addfood':
            self.uniqueSens.addFood(interest_variable)
            return "ACTION COMPLETED"
        elif interest.lower() == 'food' and interest_method.lower() == 'removefood':
            self.uniqueSens.removeFood(interest_variable)
            return "ACTION COMPLETED"
    ...
    def callActuator(self,interest,interest_method):
        ...
        # Unique sensor - food
        elif interest.lower() == 'food' and interest_method.lower() == 'getfood':
            return self.uniqueSens.getFood()
    ...
    def main(self):
        #Unique sensor
        self.uniqueSens = uniqueSensors.food()
        #Common sensors
